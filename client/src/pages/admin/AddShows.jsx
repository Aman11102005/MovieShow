...
// import { todayDateTime } from "../../lib/todayDateTime";
    ...
    <>
      ...
      <div className="overflow-x-auto pb-4">
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) => (
            <div key={movie.id} className={`relative max-w-40 duration-300 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovie(movie.id)}>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
          ...
          <input type="number" value={showPrice} onChange={(e) =>
      ...
      {Object.keys(dateTimeSelection).length > 0 && (
        <div className="mt-6">
          <h2 className="mb-2">Se1ected Date-Time</h2>
